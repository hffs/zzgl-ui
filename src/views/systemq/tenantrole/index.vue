  ...
  <div class="app-container">
   <el-form :model="queryParams" ref="queryForm" class="mmform" :inline="device!=='mobile'" label-width="68px">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="角色名称" prop="name" align="center" min-width="110px" :show-overflow-tooltip="true" />
      ...
      <el-table-column label="备注" prop="remark" align="center" min-width="110px" :show-overflow-tooltip="true" />
      <el-table-column label="操作" align="center" min-width="110px" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            size="mini"
            type="text"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="角色名称" prop="name">
          <el-input v-model="form.name" maxlength="20" placeholder="请输入角色名称" />
        </el-form-item>
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getRole(roleId).then(response => {
        ...
        this.menuIdx=response.data.menuIds
