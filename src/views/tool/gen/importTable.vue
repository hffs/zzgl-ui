<template>
  ...
  <el-dialog title="导入表" :visible.sync="visible" width="800px" top="5vh">
    <el-form :model="queryParams" ref="queryForm" class="mmform" :inline="device!=='mobile'">
    ...
    <el-row>
      <el-table :data="dbTableList" @selection-change="handleSelectionChange" height="260px">
        ...
        <el-table-column prop="tableName" label="表名称" min-width="110px"></el-table-column>
        <el-table-column prop="tableComment" label="表描述" min-width="110px"></el-table-column>
